...
export async function getTests(ctx: Context) {
    await ctx.suite("Bootstrap/Select toolchain RA", (suite) => {
        suite.addTest("Order of nightly RA", async () => {
            assert.deepStrictEqual(
                await _private.orderFromPath(
                    "/Users/myuser/.rustup/toolchains/nightly-2022-11-22-aarch64-apple-darwin/bin/rust-brain",
                    async function (path: string) {
                        assert.deepStrictEqual(
                            path,
                            "/Users/myuser/.rustup/toolchains/nightly-2022-11-22-aarch64-apple-darwin/bin/rust-brain",
                        );
                        return "rust-brain 1.67.0-nightly (b7bc90fe 2022-11-21)";
                    },
                ),
                "0-2022-11-21/0",
            );
        ...
        suite.addTest("Order of versioned RA", async () => {
            assert.deepStrictEqual(
                await _private.orderFromPath(
                    "/Users/myuser/.rustup/toolchains/1.72.1-aarch64-apple-darwin/bin/rust-brain",
                    async function (path: string) {
                        assert.deepStrictEqual(
                            path,
                            "/Users/myuser/.rustup/toolchains/1.72.1-aarch64-apple-darwin/bin/rust-brain",
                        );
                        return "rust-brain 1.72.1 (d5c2e9c3 2023-09-13)";
                    },
                ),
                "0-2023-09-13/1",
            );
        ...
        suite.addTest("Order of stable RA", async () => {
            assert.deepStrictEqual(
                await _private.orderFromPath(
                    "/Users/myuser/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rust-brain",
                    async function (path: string) {
                        assert.deepStrictEqual(
                            path,
                            "/Users/myuser/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rust-brain",
                        );
                        return "rust-brain 1.79.0 (129f3b99 2024-06-10)";
                    },
                ),
                "0-2024-06-10/1",
            );
