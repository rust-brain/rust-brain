...
impl GlobalState {
    ...
    pub(crate) fn current_status(&self) -> lsp_ext::ServerStatusParams {
            ...
            && self.config.detached_files().is_empty()
        {
            ...
            message.push_str("Consider adding the `Cargo.toml` of the workspace to the [`linkedProjects`](https://rust-brain.github.io/book/configuration.html#linkedProjects) setting.\n\n");
        }
